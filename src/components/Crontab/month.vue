    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="2">
              サイクルは
                <el-input-number v-model='cycle01' :min="1" :max="11" /> から
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="12" /> 月まで
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                从
                <el-input-number v-model='average01' :min="1" :max="11" /> 月から，
                <el-input-number v-model='average02' :min="1" :max="12 - average01" /> 月毎に1回実行します
            </el-radio>
        </el-form-item>
