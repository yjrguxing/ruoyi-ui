    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="2">
              サイクルは
                <el-input-number v-model='cycle01' :min="0" :max="58" /> から
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="59" /> 分まで
            </el-radio>
        </el-form-item>

        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                <el-input-number v-model='average01' :min="0" :max="58" /> 分から，
                <el-input-number v-model='average02' :min="1" :max="59 - average01" /> 分毎に1回実行します
            </el-radio>
        </el-form-item>
