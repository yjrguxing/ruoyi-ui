    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio :label="3" v-model='radioValue'>
              サイクルは
                <el-input-number v-model='cycle01' :min='fullYear' :max="2098"/> から
        ...
        <el-form-item>
            <el-radio :label="4" v-model='radioValue'>
                <el-input-number v-model='average01' :min='fullYear' :max="2098"/> 年から，
                <el-input-number v-model='average02' :min="1" :max="2099 - average01 || fullYear"/> 年に1回実行します
            </el-radio>
