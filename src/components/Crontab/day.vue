    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
              サイクルは
                <el-input-number v-model='cycle01' :min="1" :max="30" /> から
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="31" /> 日まで
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="4">
                从
                <el-input-number v-model='average01' :min="1" :max="30" /> 日から，
                <el-input-number v-model='average02' :min="1" :max="31 - average01" /> 日毎に1回実行します
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="5">
              毎月
                <el-input-number v-model='workday' :min="1" :max="31" /> 日の直近の平日
            </el-radio>
        </el-form-item>
