        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="2">
              サイクルは
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="59" /> 秒まで
            </el-radio>
        </el-form-item>

        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                <el-input-number v-model='average01' :min="0" :max="58" /> 秒から，
                <el-input-number v-model='average02' :min="1" :max="59 - average01" /> 秒毎に1回実行します
            </el-radio>
        </el-form-item>
