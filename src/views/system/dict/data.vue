   ...
   <div class="app-container">
      ...
      <el-dialog :title="title" v-model="open" width="500px" append-to-body>
         <el-form ref="dataRef" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="ソートを表示" prop="dictSort">
...
const data = reactive({
  ...
  rules: {
    dictLabel: [{ required: true, message: "データラベルのご入力は必須です。", trigger: "blur" }],
    dictValue: [{ required: true, message: "データキー値のご入力は必須です。", trigger: "blur" }],
    dictSort: [{ required: true, message: "データ順序のご入力は必須です。", trigger: "blur" }]
  }
});
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('辞書番号が"' + dictCodes + '"のデータ項目を削除しますか。').then(function() {
